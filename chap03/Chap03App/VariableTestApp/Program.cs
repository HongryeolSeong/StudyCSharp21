...
namespace VariableTestApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ushort ushMinVal = ushort.MinValue, ushMaxVal = ushort.MaxValue;
            ...
            uint uinMinVal = uint.MinValue, uinMaxVal = uint.MaxValue;
            Console.WriteLine($"uint 최소, 최대값은 {uinMinVal}, {uinMaxVal} 입니다.");
