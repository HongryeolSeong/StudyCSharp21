    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>
            {
                ...
                new Product() { Title = "아리리스", Star = "김태희"},
            ...
            var resProfiles = from item in profiles
                              ...
                              select new 
                              {
                                  Name = item.Name,
                                  Height = item.Height,
                                  InchHeight = item.Height * 0.393 // 임시 객체
                              };
            ...
            var resProfiles3 = from item in profiles
                               orderby item.Height
                               group item by item.Height < 175 into g // g = 그룹화 된 값들
                               select new 
                               {
            ...
            var joinProfiles2 = from p in profiles
                                ...
                                from d2 in ps.DefaultIfEmpty(new Product() { Title = "작품 없음" })
                                select new
                                {
                                   Name = p.Name,
                                   Work = d2.Title,
